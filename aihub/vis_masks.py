...
scene_id = 1
img_id = 4
# dataset_path = "OccludedObjectDataset/ours/data2/data2_syn_source/train_pbr"
# dataset_path = "/OccludedObjectDataset/ours/data2/data2_real_source/all"
dataset_path = "/OccludedObjectDataset/ours/data3/data3_1_real_source/all"

scene_path = os.path.join(dataset_path, "{:06d}".format(scene_id))
im_path = os.path.join(scene_path, "rgb/{:06d}.png".format(img_id))
