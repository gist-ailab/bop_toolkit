...
dataset_root = os.path.join(ood_root, 'ours/data3/data3_2_source/all')

bound = [[-0.3, 1.0], [-0.55, 0.55], [-0.3, 1.0]]
...
for scene_id in tqdm(scene_ids):
    ...
    for image_number in tqdm(im_ids):
        ...
        cam_t_w2c = np.array(scene_camera_info[str(image_number)]["cam_t_w2c"]).copy() 
