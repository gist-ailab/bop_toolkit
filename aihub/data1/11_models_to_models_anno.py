...
input_model_path = os.path.join(ood_root, "ours/data1/models_colored")
output_model_path = os.path.join(ood_root, "ours/data1/models_anno")
...
for model_in_path in tqdm(glob.glob(input_model_path + "/*.ply")):
  ...
  o3d.io.write_point_cloud(model_out_path, pcd, write_ascii=True)
